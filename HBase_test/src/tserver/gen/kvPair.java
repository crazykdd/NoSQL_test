...
public class kvPair implements org.apache.thrift.TBase<kvPair, kvPair._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new kvPairStandardSchemeFactory());
    schemes.put(TupleScheme.class, new kvPairTupleSchemeFactory());
  }
  ...
  public kvPair setKey(String key) {
    this.key = key;
    return this;
  }
  ...
  public kvPair setValue(String value) {
    this.value = value;
    return this;
  }
  ...
  public int compareTo(kvPair other) {
    ...
    kvPair typedOther = (kvPair)other;
  ...
  private static class kvPairStandardSchemeFactory implements SchemeFactory {
    public kvPairStandardScheme getScheme() {
      return new kvPairStandardScheme();
    }
  }

  private static class kvPairStandardScheme extends StandardScheme<kvPair> {
  ...
  private static class kvPairTupleSchemeFactory implements SchemeFactory {
    public kvPairTupleScheme getScheme() {
      return new kvPairTupleScheme();
    }
  }

  private static class kvPairTupleScheme extends TupleScheme<kvPair> {
